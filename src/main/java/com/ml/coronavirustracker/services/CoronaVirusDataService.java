package com.ml.coronavirustracker.services;
...
public class CoronaVirusDataService {
	...
	@PostConstruct //is a way to tell Spring after completion of the CoronaVirusDataService construction, execute the fetchVirusData()
	...
	public void fetchVirusData() throws IOException, InterruptedException {
		...
		HttpResponse<String> httpResponse = client.send(request, HttpResponse.BodyHandlers.ofString()); //take the body and return as a string
...
//		Iterable<CSVRecord> records = CSVFormat.DEFAULT.withHeader("Province/State", "Country/Region", "LatestTotalCases").parse(csvBodyReader);
